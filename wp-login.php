...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
	<div id="login">
		<h1><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>"><?php echo get_bloginfo( 'title', 'display' ); ?></a></h1>
	<?php
...
switch ( $action ) {
	...
	<p>
		<!-- <label for="user_login"><i class="fa fa-user"></i><?php _e( 'Username or Email Address' ); ?><br /> -->
		<i class="fa fa-user"></i> <input placeholder="Usuário" type="text" name="log" id="user_login"<?php echo $aria_describedby_error; ?> class="input" value="<?php echo esc_attr( $user_login ); ?>" size="20" autocapitalize="off" /></label>
	</p>
	<p>
		<!-- <label for="user_pass"><i class="fa fa-lock"></i><?php _e( 'Password' ); ?><br /> -->
		<i class="fa fa-lock"></i><input placeholder="Senha" type="password" name="pwd" id="user_pass"<?php echo $aria_describedby_error; ?> class="input" value="" size="20" /></label>
	</p>
		<?php
		/**
	...
	<p class="submit">
		<button type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large">Login <i style="background-image:url(http://www.dezseguros.com.br/sistema/admin/assets/global/img/syncfusion-icons-white.png)"></i></button>
	...
	<h2><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>"><?php echo get_bloginfo( 'title', 'display' ); ?></a></h2>	
	</form>
